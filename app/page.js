  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen w-full relative overflow-hidden">
      <main className="flex-grow flex flex-col items-center justify-center">
        ...
        <div className="absolute bottom-0 left-[-40%] right-0 top-[-10%] h-[1000px] w-[1000px] rounded-full -z-10 bg-[radial-gradient(circle_farthest-side,rgba(255,0,182,.15),rgba(255,255,255,0))]"></div>
        <div className="absolute bottom-0 right-[-40%] top-[-10%] h-[1000px] w-[1000px] rounded-full -z-10 bg-[radial-gradient(circle_farthest-side,rgba(255,0,182,.15),rgba(255,255,255,0))]"></div>
